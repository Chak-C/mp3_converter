...
file_name, title, thumbnail_url, duration = '', 'Standby', '', ''
...
def is_bili_link(url):
    return 'bilibili.com/video' in url or 'b23.tv/' in url or 'bilibili.com/bangumi/play' in url